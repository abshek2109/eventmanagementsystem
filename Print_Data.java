...
class Print_Data implements ActionListener{
    ...
    Print_Data(String id){
        ...
        try{
            ...
            String str = "select * from event where id = '"+id+"'";
            ...
            while(rs.next()){
              ...
              //  father = rs.getString("fname");
               ...
               // age = rs.getString("age");
                ...
                address = rs.getString("descreption");

                phone = rs.getString("time");
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("eventmanagementsystem/icon/print.jpg"));

        id9.setIcon(img);



        id8 = new JLabel("Event Details");
