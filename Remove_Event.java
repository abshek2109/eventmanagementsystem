...
class Remove_Event implements ActionListener{
	JFrame f;
    ...
    Remove_Event(){
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("eventmanagementsystem/icon/remove.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            ...
            try{
                ...
                String str = "select name,strttime from employee where emp_id ='"+t.getText()+"' ";
        ...
        if(ae.getSource()==b1){
            ...
            try{
                ...
                String str = "delete from event where id = '"+t.getText()+"'";
