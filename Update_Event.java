...
class Update_Event extends Add_Event implements ActionListener{
    ...
    Update_Event(String idaa){

        super(0);

        f=new JFrame("update Event details");
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("eventmanagementsystem/icon/add_employee.jpg"));

        id15.setIcon(img);



        id8 = new JLabel("Update Event Detail:");
    ...
    void showData(String s){
        ...
        try{
            ...
            String str = "select * from event where id = '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b && i==1){
            ...
            try{
                ...
                String str = "update event set name='"+t1.getText()+"',descreption='"+t3.getText()+"',duration='"+t4.getText()+"',id='"+t9.getText()+"' where id='"+id_emp+"'";
